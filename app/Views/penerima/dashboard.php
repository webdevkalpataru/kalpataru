      ...
      <div class="border-2 border-primary bg-white rounded-xl shadow-md p-4">
        ...
        <div class="flex gap-4">
          ...
          <div class="w-full">
            ...
            <input type="text" value="<?= session()->get('nama') ?>" readonly class="w-full bg-transparent text-gray-800 bg-gray-200  text-sm  rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-primary hover:border-primary focus:shadow" />
          </div>

          <!-- Email -->
          <div class="w-full">
            <label class="block mb-2 text-sm text-black">Email</label>
            <input type="text" value="<?= session()->get('email') ?>" readonly class="w-full bg-transparent text-gray-800 bg-gray-200  text-sm  rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-primary hover:border-primary focus:shadow" />
          </div>
        </div>
      </div>
