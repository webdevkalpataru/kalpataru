...
<body class="bg-gray-100">
    ...
    <div id="sidebar"
        ...
        <div class="relative block w-full">
            <button id="verifikasiDropdown" class="flex items-center justify-between w-full p-3 text-primary text-left font-semibold text-xl leading-snug transition-colors hover:text-primary">
                <div class="grid mr-4 place-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25ZM6.75 12h.008v.008H6.75V12Zm0 3h.008v.008H6.75V15Zm0 3h.008v.008H6.75V18Z" />
                    </svg>
                </div>
                <p class="mr-auto">Verifikasi Administrasi</p>
                <span class="ml-4">
            ...
            <div id="dropdownMenuVerifikasi" class="hidden">
                <div class="py-1 text-gray-700 text-sm">
                    <nav class="flex flex-col gap-1">
                        <button class="w-full p-3 text-left hover:bg-blue-gray-50 hover:text-primary">Perintis Lingkungan</button>
                        <button class="w-full p-3 text-left hover:bg-blue-gray-50 hover:text-primary">Pengabdi Lingkungan</button>
                        <button class="w-full p-3 text-left hover:bg-blue-gray-50 hover:text-primary">Penyelamat Lingkungan</button>
                        <button class="w-full p-3 text-left hover:bg-blue-gray-50 hover:text-primary">Pembina Lingkungan</button>
                    </nav>
                </div>
            </div>
        </div>
        ...
        <div class="relative block w-full mt-2">
            <button id="bahanSidangDropdown" class="flex items-center justify-between w-full p-3 text-primary text-left font-semibold text-xl leading-snug transition-colors hover:text-primary">
                <div class="grid mr-4 place-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0 0 12 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75Z" />
                    </svg>
                </div>
                <p class="mr-auto">Bahan Sidang</p>
                <span class="ml-4">
