...
<body class="bg-gray-100">
    <div id="sidebar" class="lg:w-[15rem] lg:h-3/4 lg:rounded-lg text-primary mb-6 relative lg:left-36 z-50">
        <!-- Profil section -->
        <div class="mb-4 border-2 border-primary rounded-lg px-4 py-2 flex items-start bg-white hidden lg:flex">
        ...
        <ul class="lg:border-2 border-t-2 border-primary lg:rounded-lg lg:px-4 lg:py-4 lg:bg-white bg-white flex justify-between fixed bottom-0 left-0 right-0 shadow-md lg:block lg:relative lg:shadow-none overflow-x-auto scroll-smooth overscroll-x-contain">
            ...
            <li class="flex items-center justify-center lg:justify-start">
                <a href="../pengusul/pemberitahuan" class="flex items-center block text-md hover:bg-secondary p-2 w-full rounded">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <li class="flex items-center justify-center lg:justify-start">
                <a href="../pengusul/alurpendaftaran" class="flex items-center block text-md hover:bg-secondary p-2 w-full rounded">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <li class="flex items-center justify-center lg:justify-start">
                <a href="../pengusul/usulansaya" class="flex items-center block text-md hover:bg-secondary p-2 w-full rounded">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <?php endif; ?>
            <li class="flex items-center justify-center lg:justify-start">
                <a href="../pengusul/panduanpendaftaran" class="flex items-center block text-md hover:bg-secondary p-2 w-full rounded">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <li class="flex items-center justify-center lg:justify-start">
                <a href="../pengusul/videopanduan" class="flex items-center block text-md hover:bg-secondary p-2 w-full rounded">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
