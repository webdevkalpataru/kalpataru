...
<body class="bg-gray-100">
    <div id="sidebar" class="w-full lg:w-[15rem] h-3/4 rounded-lg text-primary mb-6 relative lg:left-36">
        <div class="mb-4 border-2 border-primary rounded-lg px-4 py-2 flex items-start bg-white">
        ...
        <ul class="border-2 border-primary rounded-lg px-4 py-4 bg-white">
            ...
            <li class="flex items-center">
                <a href="#" class="flex items-center block text-md hover:bg-secondary p-2 w-full rounded">
                    ...
                    <span class="ml-2 text-sm">Pemberitahuan</span>
                </a>
            </li>
            <li class="flex items-center">
                <a href="#" class="flex items-center block text-md hover:bg-secondary p-2 w-full rounded">
                    ...
                    <span class="ml-2 text-sm">Alur Pendaftaran</span>
                </a>
            </li>
            <li class="flex items-center text-gray-400">
                <a href="#" class="flex items-center block text-md hover:bg-secondary p-2 w-full rounded">
                    ...
                    <span class="ml-2 text-sm">Tambah Calon Usulan</span>
                </a>
            </li>
            <li class="flex items-center">
                <a href="#" class="flex items-center block text-md hover:bg-secondary p-2 w-full rounded">
                    ...
                    <span class="ml-2 text-sm">Usulan Saya</span>
                </a>
            </li>
            <li class="flex items-center">
                <a href="#" class="flex items-center block text-md hover:bg-secondary p-2 w-full rounded">
                    ...
                    <span class="ml-2 text-sm">Panduan Pendaftaran</span>
                </a>
            </li>
            <li class="flex items-center">
                <a href="#" class="flex items-center block text-md hover:bg-secondary p-2 w-full rounded">
                    ...
                    <span class="ml-2 text-sm">Video Panduan</span>
                </a>
            </li>
            <li class="flex items-center">
                <a href="#" class="flex items-center block text-md hover:bg-secondary p-2 w-full rounded">
                    ...
                    <span class="ml-2 text-sm">Keluar</span>
                </a>
            </li>
        </ul>
