    ...
    <section class="grid md:grid-cols-[300px_1fr] grid-cols-1 h-screen">
        ...
        <div class="flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md md:h-[calc(100vh)] w-full max-w-[300px] mx-auto md:mx-0 p-6">
            <div class="mb-2 flex items-center gap-4 p-4">
                ...
                <!-- <p class="block antialiased font-sans text-lg font-bold leading-relaxed text-blue-gray-900">Admin</p> -->
            </div>
            ...
            <nav class="flex flex-col gap-1 font-sans text-base font-normal text-gray-700">
                <div class="block relative w-full">
                    <div data-selected="false" role="button" data-ripple-dark="true" tabindex="0" class="flex items-center w-full p-3 rounded-lg text-start leading-tight transition-all hover:bg-gray-50 focus:bg-gray-50 hover:text-gray-900">
                        <div class="grid place-items-center mr-4">
                            <img src="https://www.material-tailwind.com/img/avatar1.jpg" class="object-cover rounded-full w-9 h-9" />
                        </div>
                        <p class="font-normal text-inherit mr-auto">Nama Admin</p>
                    </div>
                </div>
                ...
                <!-- Additional links -->
                <div class="flex items-center w-full p-3 rounded-lg hover:bg-gray-100">Products</div>
                <div class="flex items-center w-full p-3 rounded-lg hover:bg-gray-100">Orders</div>
                <div class="flex items-center w-full p-3 rounded-lg hover:bg-gray-100">Customers</div>

                <hr class="my-2 border-gray-200" />
                <div class="flex items-center w-full p-3 rounded-lg hover:bg-gray-100">Keluar</div>
            </nav>
        </div>
                ...
                <header class="bg-white shadow">
                    <div class="container mx-auto flex items-center justify-between p-6">
                        ...
                        <div class="flex items-center">
                            <p class="text-gray-500 mr-4">Hello, Admin</p>
                            <button class="bg-blue-500 text-white px-4 py-2 rounded-lg">Logout</button>
                        </div>
                    </div>
                </header>

                <!-- Main Content -->
                <div class="flex-1 p-6 container mx-auto">
                    <!-- Cards Summary -->
                    <div class="grid gap-6 mb-8 md:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div class="flex items-center p-4 bg-white shadow rounded-lg">
                            ...
                            <div>
                                <p class="mb-2 text-sm font-medium text-gray-600">Orders</p>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div class="bg-white shadow rounded-lg p-6">
                            ...
                            <div>
                                <!-- Placeholder for Chart (You can integrate a real chart library like Chart.js here) -->
                                <div class="w-full h-64 bg-gray-200 flex items-center justify-center text-gray-500">[Insert Chart Here]</div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white shadow rounded-lg p-6">
                            ...
                            <table class="w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="px-4 py-2">#1235</td>
                                        <td class="px-4 py-2">Jane Smith</td>
                                        <td class="px-4 py-2 text-yellow-600">Pending</td>
                                        <td class="px-4 py-2">$90.00</td>
                                    </tr>
                                    <tr class="bg-gray-50">
                                        <td class="px-4 py-2">#1236</td>
                                        <td class="px-4 py-2">Bob Lee</td>
