...
<body class="bg-gray-100">
    ...
    <!-- Sidebar -->
    <div id="sidebar" class="fixed top-0 left-0 z-40 h-full w-64 -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out flex flex-col rounded-xl bg-white bg-clip-border px-4 py-8 text-gray-700 shadow-xl shadow-blue-gray-900/5">
