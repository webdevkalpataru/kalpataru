                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <?php if (session('errors.nik_individu')): ?>
                                    <p class="text-red-500 text-sm mt-2"><?= session('errors.nik_individu') ?></p>
                                <?php endif; ?>
                            </div>
                            <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <?php if (session('errors.nama_ketua')): ?>
                                    <p class="text-red-500 text-sm mt-2"><?= session('errors.nama_ketua') ?></p>
                                <?php endif; ?>
                            </div>
                            <div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="nama_individu" value="<?= old('nama_individu') ?>" class="w-full bg-transparent placeholder:text-slate-400 text-primary text-sm border-2 border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-primary hover:border-primary focus:shadow" />
                                <?php if (session('errors.nama_individu')): ?>
                                    <p class="text-red-500 text-sm mt-2"><?= session('errors.nama_individu') ?></p>
                                <?php endif; ?>
                            </div>
                            <div>
                                <label class="block mb-2 text-sm text-black">NIK</label>
                                <input type="text" name="nik_individu" value="<?= old('nik_individu') ?>" class="w-full bg-transparent placeholder:text-slate-400 text-primary text-sm border-2 border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-primary hover:border-primary focus:shadow" />
                                <?php if (session('errors.nik_individu')): ?>
                                    <p class="text-red-500 text-sm mt-2"><?= session('errors.nik_individu') ?></p>
                                <?php endif; ?>
                            </div>
