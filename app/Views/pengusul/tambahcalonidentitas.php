            ...
            <div class="relative flex flex-col w-full max-w-2xl mx-auto mb-4 rounded-xl border-2 border-primary bg-white shadow-md lg:p-8 p-4">
                ...
                <div class="w-full pt-1 px-4 lg:mb-8">
                    <div class="relative flex items-center justify-between w-full flex-wrap gap-4 sm:gap-8">
                        ...
                        <!-- Step 1 -->
                        <button id="identitasButton" data-target="identitas" type="button" class="relative z-10 btn-section grid w-8 h-8 sm:w-10 sm:h-10 font-bold text-white transition-all duration-300 bg-accent2 border-2 border-accent2 rounded-full place-items-center">
                        ...
                        <!-- Step 2 -->
                        <button id="kegiatanButton" data-target="kegiatan" type="button" class="relative z-10 btn-section grid w-8 h-8 sm:w-10 sm:h-10 font-bold text-white transition-all duration-300 bg-accent2 border-2 border-accent2 rounded-full place-items-center">
                            <div class="absolute -bottom-8 w-max text-center">
                                <p class="lg:block hidden font-sans text-xs lg:text-md antialiased font-semibold leading-relaxed tracking-normal text-gray-700 w-28 h-8">
                                    Kegiatan Calon
                                </p>
                        ...
                        <!-- Step 3 -->
                        <button id="dampakButton" data-target="dampak" type="button" class="relative z-10 btn-section grid w-8 h-8 sm:w-10 sm:h-10 font-bold text-white transition-all duration-300 bg-accent2 border-2 border-accent2 rounded-full place-items-center">
                            <div class="absolute -bottom-8 w-max text-center">
                                <p class="lg:block hidden font-sans text-xs lg:text-md antialiased font-semibold leading-relaxed tracking-normal text-gray-700 w-28 h-8">
                                    Dampak
                                </p>
                        ...
                        <!-- Step 4 -->
                        <button id="pmikButton" data-target="pmik" type="button" class="relative z-10 btn-section grid w-8 h-8 sm:w-10 sm:h-10 font-bold text-white transition-all duration-300 bg-accent2 border-2 border-accent2 rounded-full place-items-center">
                            <div class="absolute -bottom-8 w-max text-center">
                                <p class="lg:block hidden font-sans text-xs lg:text-md antialiased font-semibold leading-relaxed tracking-normal text-gray-700 w-28 h-8">
                                    PMIK
                                </p>
                        ...
                        <!-- Step 5 -->
                        <button id="keswadayaanButton" data-target="keswadayaan" type="button" class="relative z-10 btn-section grid w-8 h-8 sm:w-10 sm:h-10 font-bold text-white transition-all duration-300 bg-accent2 border-2 border-accent2 rounded-full place-items-center">
                            <div class="absolute -bottom-8 w-max text-center">
                                <p class="lg:block hidden font-sans text-xs lg:text-md antialiased font-semibold leading-relaxed tracking-normal text-gray-700 w-28 h-8">
                                    Keswadayaan dan Kebudayaan
                                </p>
                            </div>
                        </button>

                        <!-- Step 6 -->
                        <button id="keistimewaanButton" data-target="keistimewaan" type="button" class="relative z-10 btn-section grid w-8 h-8 sm:w-10 sm:h-10 font-bold text-white transition-all duration-300 bg-accent1 border-2 border-accent2 rounded-full place-items-center">
                            <div class="absolute -bottom-8 w-max text-center">
                                <p class="lg:block hidden font-sans text-xs lg:text-md antialiased font-semibold leading-relaxed tracking-normal text-gray-700 w-28 h-8">
                                    Keistimewaan
                                </p>
                ...
                <div id="identitas" class="form-section flex flex-col w-full md:w-3/4 rounded-lg border-2 border-gray-300 bg-white shadow-lg p-6">
                    <?php if ($kategori == 'Penyelamat Lingkungan'): ?>
                        <form action="/pendaftaran/simpanData" method="post" class="mt-4 mb-2 w-full" enctype="multipart/form-data" id="identitas">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="form_type" value="identitas">
                    ...
                    <?php else: ?>
                        <form id="identitas" action="/pendaftaran/simpanData" method="post" class="mt-4 mb-2 w-full" enctype="multipart/form-data" id="identitas">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="form_type" value="identitas">
