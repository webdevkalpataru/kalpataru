                    ...
                    <table class="w-full text-left table-auto min-w-max">
                        ...
                        ?>
                            <tr class="hover:bg-slate-100">
                                ...
                                <td class="p-4 border-b border-slate-200 text-center">
                                    <p id="status<?= $key ?>" class="block text-xs font-bold text-accepted w-24"><?= $item['status_pendaftaran'] ?></p>
                                </td>
                                <td class="p-4 border-b border-slate-200 text-center">
                                ...
                                <?php if(in_array($item['status_pendaftaran'], ['Draft', 'Perlu Perbaikan'])): ?>
                                ...
                                <?php if($item['status_pendaftaran'] === 'Perlu Perbaikan'): ?>
