        ...
        <div class="min-h-screen flex flex-col">
            ...
            <header class="bg-white shadow">
                <div class="container mx-auto flex items-center justify-between p-4 md:p-6">
                    <h1 class="text-xl font-bold text-slate-800 mb-2">Verifikasi Administrasi Kategori Perintis Lingkungan</h1>
                </div>
            </header>
                                    ...
                                    <?php foreach ($usulan as $item): ?>
                                        <tr class="hover:bg-slate-100">
                                            ...
                                            <td class="p-4 border-b border-slate-200 text-center flex justify-center ">
                                                <button class="catatanButton  rounded-md py-2 px-2 text-center font-semibold text-xs text-primary" type="button">
    ...
    <script>
        ...
        catatanButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                document.querySelector('input[name="id_pendaftaran"]').value = idPendaftaran; 
