...
<body class="bg-site">
    ...
    <section id="berita" class="w-full h-[25rem] relative">
        <img src="/images/hero.png" alt="berita" class="w-full h-full object-cover object-center md:object-center">

        <div class="absolute inset-0 flex flex-col justify-center items-center text-white text-center">
            <h1 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold">Berita</h1>
            <p class="text-sm sm:text-base md:text-lg mt-2 sm:mt-4">Dapatkan berita terkini tentang keberhasilan dan tantangan dalam pelestarian alam</p>
        </div>
    </section>
    ...
    <section id="beritacontent">
        <div class="container mx-auto">
            ...
            <div class="flex justify-between items-center my-6">
                <h1 class="text-md font-semibold">Hasil : 29 Berita</h1>
                <div class="relative">
                    <input
            ...
            <div class="grid gap-4">
                ...
                <div class="bg-white rounded-lg shadow-md flex overflow-hidden">
                    <img src="/images/pengumuman1.png" alt="berita" class="w-48 object-cover">
                    <div class="p-4">
                        <h2 class="text-xl font-semibold mb-2">Berita: Pembukaan Pendaftaran Kalpataru</h2>
