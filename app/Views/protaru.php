...
<body>
    ...
    <div class="max-w-5xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex flex-col items-center gap-4">
        <!-- Baris pertama: 3 card -->
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 justify-center">
            <div
                class="card w-80 h-auto bg-gradient-to-tr from-[#39d2f8] to-[#306160] rounded-2xl overflow-hidden relative transition-all duration-300 hover:shadow-[0_0_30px_rgba(0,183,255,0.5)]">
                <div class="card-content p-4 relative z-10">
                    <div class="flex items-center justify-center mb-4">
                        <img src="/images/arieanggara.png" alt="arieanggara" class="w-1/2 h-1/2">
                    </div>
                    <div class="flex justify-between">
                        <button
                            class="w-full group/button relative py-2 inline-flex items-center justify-start overflow-hidden text-base font-semibold text-white transition-all duration-300 ease-in-out">
                            <span class="text-lg">Arie Anggara
                                <div
                    ...
                    <div class="mb-4">
                        <h3 class="text-xs font-semibold text-white/80 mb-2">Univ. Nusa Mandiri</h3>
                        <div class="flex flex-wrap -mx-1">
                            <div
                                ...
                                Programmer MSIB Batch 7 Kampus Merdeka
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col items-center gap-4">
                        <div class="flex gap-4">
                            <div class="instagram-button">
                                <button class="relative w-6 h-6 rounded-full group">
                                    <div
                                        class="floater w-full h-full absolute top-0 left-0 bg-purple-400 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                                    <div
                                        class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-purple-400 rounded-full">
                                        <svg
                            ...
                            <div class="github-button">
                                <button class="relative w-6 h-6 rounded-full group">
                                    <div
                                        class="floater w-full h-full absolute top-0 left-0 bg-black rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                                    <div
                            ...
                            <div class="linkedin-button">
                                <button class="relative w-6 h-6 rounded-full group">
                                    <div
                                        class="floater w-full h-full absolute top-0 left-0 bg-blue-500 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                                    <div
                            ...
                            <div class="email-button">
                                <button class="relative w-6 h-6 rounded-full group">
                                    <div
                                        class="floater w-full h-full absolute top-0 left-0 bg-red-400 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                                    <div
            ...
            <div
                ...
                <div class="card-content p-4 relative z-10">
                    <div class="flex items-center justify-center mb-4">
                        <img src="/images/aisyahwulandari.png" alt="aisyahwulandari" class="w-1/2 h-1/2">
                    </div>
                    <div class="flex justify-between">
                        <button
                            class="w-full group/button relative py-2 inline-flex items-center justify-start overflow-hidden text-base font-semibold text-white transition-all duration-300 ease-in-out">
                            <span class="text-lg">Aisyah Wulandari
                                <div
                                    class="absolute inset-0 flex h-full w-full justify-center [transform:skew(-13deg)_translateX(-100%)] group-hover/button:duration-1000 group-hover/button:[transform:skew(-13deg)_translateX(100%)]">
                                    <div class="relative h-full w-10 bg-white/30"></div>
                                </div>
                    ...
                    <div class="mb-4">
                        <h3 class="text-xs font-semibold text-white/80 mb-2">Univ. Gunadarma</h3>
                        <div class="flex flex-wrap -mx-1">
                            <div
                                class="px-2 py-1 m-0.5 bg-white/10 rounded-full text-xs font-medium text-white/70 shadow-sm border border-white/20 transition-all duration-300 hover:bg-white/20">
                                Programmer MSIB Batch 7 Kampus Merdeka
            ...
            <div
                ...
                <div class="card-content p-4 relative z-10">
                    <div class="flex items-center justify-center mb-4">
                        <img src="/images/ariusaurelius.png" alt="ariusaurelius" class="w-1/2 h-1/2">
                    </div>
                    <div class="flex justify-between">
                        <button
                            class="w-full group/button relative py-2 inline-flex items-center justify-start overflow-hidden text-base font-semibold text-white transition-all duration-300 ease-in-out">
                            <span class="text-lg">Arius Aurelius
                                <div
                                    class="absolute inset-0 flex h-full w-full justify-center [transform:skew(-13deg)_translateX(-100%)] group-hover/button:duration-1000 group-hover/button:[transform:skew(-13deg)_translateX(100%)]">
                                    <div class="relative h-full w-10 bg-white/30"></div>
                                </div>
                    ...
                    <div class="mb-4">
                        <h3 class="text-xs font-semibold text-white/80 mb-2">President Univerity</h3>
                        <div class="flex flex-wrap -mx-1">
                            <div
                                class="px-2 py-1 m-0.5 bg-white/10 rounded-full text-xs font-medium text-white/70 shadow-sm border border-white/20 transition-all duration-300 hover:bg-white/20">
                                Programmer MSIB Batch 7 Kampus Merdeka
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 justify-center">
            <div
                ...
                <div class="card-content p-4 relative z-10">
                    <div class="flex items-center justify-center mb-4">
                        <img src="/images/putramauluddienjumena.png" alt="putramauluddienjumena" class="w-1/2 h-1/2">
                    </div>
                    <div class="flex justify-between">
                        <button
                            class="w-full group/button relative py-2 inline-flex items-center justify-start overflow-hidden text-base font-semibold text-white transition-all duration-300 ease-in-out">
                            <span class="text-lg">Putra Mauluddien Jumena
                                <div
                                    class="absolute inset-0 flex h-full w-full justify-center [transform:skew(-13deg)_translateX(-100%)] group-hover/button:duration-1000 group-hover/button:[transform:skew(-13deg)_translateX(100%)]">
                                    <div class="relative h-full w-10 bg-white/30"></div>
                                </div>
            ...
            <div
                ...
                <div class="card-content p-4 relative z-10">
                    <div class="flex items-center justify-center mb-4">
                        <img src="/images/sulthanizzafalqahi.png" alt="sulthanizzafalqahi" class="w-1/2 h-1/2">
                    </div>
                    <div class="flex justify-between">
                        <button
                            class="w-full group/button relative py-2 inline-flex items-center justify-start overflow-hidden text-base font-semibold text-white transition-all duration-300 ease-in-out">
                            <span class="text-lg">Sulthan Izza Falqahi
                                <div
                                    class="absolute inset-0 flex h-full w-full justify-center [transform:skew(-13deg)_translateX(-100%)] group-hover/button:duration-1000 group-hover/button:[transform:skew(-13deg)_translateX(100%)]">
                                    <div class="relative h-full w-10 bg-white/30"></div>
                                </div>
                    ...
                    <div class="mb-4">
                        <h3 class="text-xs font-semibold text-white/80 mb-2">Univ. Pendidikan Indonesia</h3>
                        <div class="flex flex-wrap -mx-1">
                            <div
                                class="px-2 py-1 m-0.5 bg-white/10 rounded-full text-xs font-medium text-white/70 shadow-sm border border-white/20 transition-all duration-300 hover:bg-white/20">
                                Programmer MSIB Batch 7 Kampus Merdeka
