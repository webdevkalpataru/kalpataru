    ...
    <section id="pengumumancontent">
        <div class="container mx-auto">
            ...
            <div class="flex justify-between items-center my-6">
                <h1 class="text-xs:lg:text-md ml-4 lg:ml-0 font-semibold">Hasil : 29 Pengumuman</h1>
            ...
            <div class="grid gap-4 px-4 lg:px-0">
                ...
                <div class="bg-white rounded-lg shadow-md flex flex-col md:flex-row overflow-hidden">
                    <img src="/images/pengumuman1.png" alt="pengumuman" class="w-full md:w-48 h-32 md:h-auto object-cover">
                    <div class="p-4">
                        <h2 class="text-lg md:text-xl font-semibold mb-2">Pengumuman Pembukaan Pendaftaran Kalpataru</h2>
