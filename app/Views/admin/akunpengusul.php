        ...
        <table class="w-full text-left table-auto min-w-max">
          <thead>
            <tr>
              ...
              <th class="p-4 transition-colors cursor-pointer border-b border-slate-300 bg-slate-50 hover:bg-slate-100">
                <p class="flex items-center justify-center gap-2 text-sm font-bold leading-none text-slate-800">Jenis Instansi</p>
              </th>
              <th class="p-4 transition-colors cursor-pointer border-b border-slate-300 bg-slate-50 hover:bg-slate-100">
              ...
              <th class="p-4 transition-colors cursor-pointer border-b border-slate-300 bg-slate-50 hover:bg-slate-100">
                <p class="flex items-center justify-center gap-2 text-sm font-bold leading-none text-slate-800">Provinsi</p>
              </th>
              <th class="p-4 transition-colors cursor-pointer border-b border-slate-300 bg-slate-50 hover:bg-slate-100">
                <p class="flex items-center justify-center gap-2 text-sm font-bold leading-none text-slate-800">Detail</p>
              </th>
              <th class="p-4 transition-colors cursor-pointer border-b border-slate-300 bg-slate-50 hover:bg-slate-100">
          ...
          <tbody>
            <tr class="hover:bg-slate-50">
              ...
              <td class="p-4 border-b text-sm border-slate-200 text-center">Non Pemerintah</td>
              <td class="p-4 border-b text-sm border-slate-200 text-center">Joko Susilo</td>
              ...
              <td class="p-4 border-b border-slate-200 text-center">
                <button class="toggleBtn mt-4 w-3/2 rounded-md py-2 px-2 text-center text-sm text-white shadow-md hover:shadow-lg bg-footer active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" type="button" data-active="Aktif" data-inactive="Aktifkan">
                  Aktifkan
                </button>
              </td>
              <td class="p-4 border-b border-slate-200 text-center">
