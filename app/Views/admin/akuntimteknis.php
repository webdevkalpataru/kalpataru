            ...
            <thead>
              <tr>
                <th class="p-4 transition-colors cursor-pointer border-b border-slate-300 bg-slate-50 hover:bg-slate-100">
                  <p class="flex items-center font-bold justify-center gap-2 text-sm  leading-none text-slate-800">No</p>
                </th>
                <th class="p-4 transition-colors cursor-pointer border-b border-slate-300 bg-slate-50 hover:bg-slate-100">
                  <p class="flex items-center font-bold justify-center gap-2 text-sm  leading-none text-slate-800">Nama</p>
                </th>
                <th class="p-4 transition-colors cursor-pointer border-b border-slate-300 bg-slate-50 hover:bg-slate-100">
                  <p class="flex items-center font-bold justify-center gap-2 text-sm  leading-none text-slate-800">Akun</p>
                </th>
                
                <th class="p-4 transition-colors cursor-pointer border-b border-slate-300 bg-slate-50 hover:bg-slate-100">
                  <p class="flex items-center font-bold justify-center gap-2 text-sm  leading-none text-slate-800">NIP</p>
                </th>
                <th class="p-4 transition-colors cursor-pointer border-b border-slate-300 bg-slate-50 hover:bg-slate-100">
                  <p class="flex items-center font-bold justify-center gap-2 text-sm leading-none text-slate-800">No SK</p>
                </th>
                <th class="p-4 transition-colors cursor-pointer border-b border-slate-300 bg-slate-50 hover:bg-slate-100">
                  <p class="flex items-center font-bold justify-center gap-2 text-sm  leading-none text-slate-800">Kata Sandi</p>
                </th>
                <th class="p-4 transition-colors cursor-pointer border-b border-slate-300 bg-slate-50 hover:bg-slate-100">
                  <p class="flex items-center font-bold  justify-center gap-2 text-sm  leading-none text-slate-800">Hapus</p>
                </th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr class="hover:bg-slate-50">
                ...
                <td class="p-4 border-b border-slate-200 text-center"><p class="block text-sm text-slate-800">Sutarman</p></td>
