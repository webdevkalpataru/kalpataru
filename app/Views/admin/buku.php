...
<body class="lg:flex">
  ...
  <div class="container mx-auto flex items-center justify-between p-4 md:p-6">
          <h1 class="text-xl md:text-2xl font-semibold text-gray-700">Buku</h1>
          <div class="flex items-center">
            ...
            <button class="bg-rejected text-white px-3 py-2 md:px-4 md:py-2 rounded-lg">Keluar</button>
                ...
                <div>
                    <button href="./tambahbuku" id="tambahbuku" class="w-48 rounded-md py-2 text-center text-sm text-white transition-all shadow-md hover:shadow-lg bg-primary hover:bg-primaryhover active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" type="button"> <span>&#10010</span> Tambah Buku</button>
                </div>
    ...
    <thead>
        <tr>
            <th
                class="p-4 text-center transition-colors cursor-pointer border-b border-slate-300 bg-slate-50 hover:bg-slate-100">
                <p
                    class="flex items-center justify-center gap-2 text-sm font-bold leading-none text-slate-800">
                    No
                </p>
            </th>
            ...
            <th
                class="p-4 text-center transition-colors cursor-pointer border-b border-slate-300 bg-slate-50 hover:bg-slate-100">
                <p
                    class="flex items-center gap-2 justify-center text-sm font-bold leading-none text-slate-800">
                    Tanggal
                </p>
            </th>
            <th
            ...
            <th
                class="p-4 text-center transition-colors cursor-pointer border-b border-slate-300 bg-slate-50 hover:bg-slate-100">
                <p
                    class="flex items-left justify-center gap-2 text-sm font-bold leading-none text-slate-800">
                    Hapus
                </p>
            </th>
        </tr>
