...
<body class="lg:flex">
            ...
            <div class="relative  flex flex-col w-full h-full overflow-scroll bg-white shadow-md rounded-lg bg-clip-border my-6">
                <table class="w-full text-left table-auto min-w-max">
                    ...
                    <tbody>
                        <?php if (count($berita) > 0): ?>
                            ...
                            ?>
                                <tr class="hover:bg-slate-50">
                                    ...
                                    <td class="p-4 border-b border-slate-200">
                                        <p class="block text-sm text-slate-800"><?= esc($b['penulis']) ?></p>
                                    </td>
                                    <td class="p-4 border-b border-slate-200">
                                    ...
                                    <td class="p-4 border-b border-slate-200">
                                        <div>
                                            <a href="/admin/berita/<?= $b['slug']; ?>" class="mt-4 w-3/2 rounded-md py-2 px-2 text-center text-sm text-white transition-all shadow-md hover:shadow-lg bg-primary hover:bg-primaryhover">Selengkapnya</a>
                                        </div>
                                    </td>
                                    <td class="p-4 border-b border-slate-200">
                                        <form action="/admin/berita/hapus/<?= $b['id_berita'] ?>" method="POST">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="6" class="p-4 text-center text-slate-800">Belum ada berita.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
    ...
    <div id="deleteModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
        <div class="bg-white rounded-lg p-8 flex flex-col max-w-md">
            <h2 class="text-left text-lg font-bold text-red-600 mb-2">Konfirmasi Hapus Berita</h2>
            <p class="text-justify text-sm text-slate-600 mb-4">Apakah Anda yakin ingin menghapus berita ini? Berita yang sudah dihapus tidak dapat dipulihkan kembali.</p>
            <div class="flex justify-end space-x-4">
                ...
                <button id="confirmDeleteButton" class="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md">Ya, Hapus Berita</button>
            </div>
        </div>
    </div>
