...
<body class="lg:flex">
            ...
            <div class="relative  flex flex-col w-full h-full bg-white shadow-md rounded-lg bg-clip-border my-6">
                <table class="w-full text-left table-auto min-w-max">
                    ...
                    <tbody>
                                ...
                                <tr class="hover:bg-slate-50">
                                    ...
                                    <td class="p-4 border-b border-slate-200 text-center">
                                        <form method="POST" action="/admin/updatestatusvideo">
                                            <input type="hidden" name="id_video" value="<?= esc($b['id_video']); ?>">
                                            <select name="status" class="status-dropdown ml-2 border-2 border-primary text-primary rounded-md shadow-sm text-xs" data-id="<?= $b['id_video'] ?>">
                                                <?php
                        ...
                        <?php endif; ?>
                        <!-- Repeat the rest of the table rows similarly -->
                    </tbody>
                </table>
    ...
    <div id="deleteModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
        <div class="bg-white rounded-lg p-8 flex flex-col max-w-md">
            <h2 class="text-left text-lg font-bold text-red-600 mb-2">Konfirmasi Hapus Video</h2>
            ...
            <div class="flex justify-end space-x-4">
                ...
                <button id="confirmDeleteButton" class="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md">Ya, Hapus Video</button>
            </div>
        </div>
    </div>
