                    ...
                    <thead>
                        <tr>
                            <th
                                ...
                                <p
                                    class="flex items-center justify-center gap-2 text-sm font-normal leading-none text-slate-800">
                                    No
                                </p>
                            </th>
                    ...
                    <tbody>
                        <tr class="hover:bg-slate-50">
                            <td class="p-4 border-b border-slate-200">
                                <p class="block text-sm justify-center text-slate-800">
                                    01
                                </p>
                            </td>
                            <td class="p-4 border-b border-slate-200">
                            ...
                            <td class="p-4 border-b border-slate-200">
                                <p class="block text-sm jus text-slate-800">
                                    Jawa Barat
                                </p>
                            </td>
                            <td class="p-4 border-b border-slate-200">
