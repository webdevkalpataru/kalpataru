        ...
        <form id="isiArtikelForm" class="mt-4 mb-2 w-full">
                <div class="grid grid-cols-1 gap-4" id="formContainer">
                    ...
                    <div>
                        ...
                        <textarea id="berita" class="w-full bg-transparent placeholder:text-slate-400 text-primary text-sm border-2 border-slate-200 rounded-md px-3 py-2 focus:outline-none focus:border-primary hover:border-primary transition duration-300 ease" rows="4"
                           ></textarea>
                       
                    </div>
                    <div>
                        <label class="block mb-2 text-sm text-black">Unggah Foto Pengumuman <span class="text-primary">(.jpg/jpeg)</span></label>
                        <input id="fotoberita" type="file" accept="application/jpg,application/jpeg"
